...
import { Container, ContentForms, HeaderStyled, MainStyled, InputTextArea } from './styles'
      ...
      <MainStyled>
        ...
        <Container>
          ...
          <ContentForms onSubmit={handleSubmit(submitForm)}>
            ...
            <div>
              <Input placeholder='Telefone celular' register={register} name='telephone' border='none' heigth='30px' fontSize='15px'/>
